...
public class Main extends Application {
	...
	public void start(Stage original) throws Exception {
		...
		suppliersLay.getChildren().addAll(suppliersLab, registerSupplier, deregisterSupplier, registerOffering,
				deregisterOffering);
		...
		peopleLay.getChildren().addAll(peopleLab, registerCustomer, registerDoctor, registerEmployee, deletePerson,
