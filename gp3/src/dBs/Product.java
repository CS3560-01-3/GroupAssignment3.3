...
public class Product {
	...
	public static void register(Stage primaryStage, Scene prev) {
		...
		Label pagePrompt = new Label("Enter the product name, price and quantity below");
		...
		regInputs.getChildren().addAll(pagePrompt, productName, price,quantity, submit, back);
